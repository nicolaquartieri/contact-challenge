...
public class BaseFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        retrofit = RetrofitProvider.getRetrofitClient();
        ...
        if (savedInstanceState != null) {
            ...
            mPendingResponse = savedInstanceState.getParcelable(STATE_PENDING_RESPONSE);
        }
    }
    ...
    /** Called to start loading data from services. */
    ...
    public boolean onLoadingResponse(Intent intent, boolean isLoading) {
        ...
        if (intent.getExtras() != null) {
            ApiErrorResponse apiErrorResponse = intent.getParcelableExtra(
                    ApiErrorResponse.EXTRA_RESPONSE_ERROR);
